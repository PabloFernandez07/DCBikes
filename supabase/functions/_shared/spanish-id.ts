// supabase/functions/_shared/spanish-id.ts
//
// Validación algorítmica de identificadores fiscales españoles (NIF persona
// física, NIE y CIF empresa) con dígito/letra de control. Espejo exacto de
// `src/lib/spanish-id.ts` del frontend, para usar en Edge Functions (Deno).
//
// Se usa como gate legal en la emisión de facturas: un NIF/CIF de emisor
// inválido (p. ej. el placeholder "12345678X", cuya letra correcta sería "Z")
// debe bloquear la emisión — una factura con NIF inválido es nula y quema un
