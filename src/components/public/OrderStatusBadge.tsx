// Public copy of admin/OrderStatusBadge with same API.
// Razón: evitamos importar componentes de admin en rutas públicas para que la
// división de chunks (lazy admin) no contamine los bundles de las páginas
// públicas, y para mantener una barrera explícita entre layers.
